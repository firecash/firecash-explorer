...
const DONATION_ADDRESS = "firecash:pyfjy228l6gukj2vwztyq6q88eeyggjhvcuzf2jx8u4lvla42d6x0y3dsgp0wzggcc9cytqreh8r7mn";

export function meta() {
  return [
    { title: "Donate to Support | FireCash Explorer" },
    {
      name: "description",
      content:
        "Support FireCash Explorer and help us maintain and improve this open-source FireCash blockchain explorer. Every donation matters.",
    },
    {
      name: "keywords",
      content: "FireCash donate, support explorer, FireCash donation, contribute to blockchain explorer, open-source",
    },
  ];
}
    ...
    <MainBox>
      <div className="grid grid-cols-[1fr_1fr] gap-x-10">
        <div className="col-span-2 md:col-span-1">
          <h1>Support FireCash Explorer Development</h1>
          <p className="py-6">
            FireCash is built by a passionate and dedicated community of people from all backgrounds, working together to
          ...
          <p>
            ...
            and give us the chance to keep pushing boundaries, exploring new ideas, and making FireCash even better.
          </p>
