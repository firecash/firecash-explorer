...
import FcMark from "./assets/fc-mark.svg";
...
const QrCodeModal = (props: QrCodeModalProps) => {
  ...
  return (
    <div
      className="fixed top-0 left-0 z-10 flex h-screen w-full items-center justify-center bg-[#000]/80"
    ...
    >
      ...
      >
        ...
        <div className="relative mx-8 mb-6 w-3/4">
          ...
          />
          <div className="absolute top-1/2 left-1/2 h-14 w-14 -translate-x-1/2 -translate-y-1/2 bg-[#fff]">
            <FcMark className="absolute top-1/2 left-1/2 h-11 w-11 -translate-x-1/2 -translate-y-1/2 bg-[#fff]" />
          </div>
        </div>
