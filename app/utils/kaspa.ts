// ZKas addresses share Kaspa's bech32m alphabet. Transparent addresses carry
...
export const isValidKaspaAddressSyntax = (address: string) =>
  /^(zkas|firecash)(test|dev|sim)?:[qpzry9x8gf2tvdw0s3jn54khce6mua7l]{50,130}$/.test(address);
